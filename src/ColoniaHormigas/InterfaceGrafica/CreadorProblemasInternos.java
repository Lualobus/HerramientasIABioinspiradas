...
import ColoniaHormigas.InterfaceGrafica.CreadorProblemasInternos;
import ColoniaHormigas.InterfaceGrafica.InterfazGrafica;
import fam.utilidades.*;
import ColoniaHormigas.InterfaceGrafica.EditorProblemas;
...
public class CreadorProblemasInternos {
  ...
  public void compilarArchivoProblema(String codigo){
    try{
     ...
     fichProblema = new FicheroEscritura("./src/ColoniaHormigas/Problemas/Problema"+nombreProblema+".java");
     fichProblema.abrir();
     fichProblema.print("package ColoniaHormigas.Problemas;\n"+codigo);
     fichProblema.cerrar();

     //compilamos el fichero y lo guardamos en el directorio relativo al problema (en la carpeta classes)
     String salidaJavac = JavacWrapper.compile(System.getProperty("user.dir")+"/src","ColoniaHormigas/Problemas/Problema" + nombreProblema + ".java", System.getProperty("user.dir")+"/classes");
