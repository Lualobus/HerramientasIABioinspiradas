...
public class CreadorProblemasExternos {
  ...
  public CreadorProblemasExternos (String nombreProblema, String pathProblemas) throws IOException{
    ...
    FicheroEscritura fichEstado = new FicheroEscritura(pathProblemas+"/"+nombreProblema+"/Estado"+nombreProblema+".java");
    fichEstado.abrir();
    fichEstado.print(CodigoBase.getCodigoEstado(nombreProblema));
    fichEstado.cerrar();
